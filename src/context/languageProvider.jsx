...
const translations = {
  en: {
    ...
    projectTitle4: "Invoice App",
    projectDescription4: "A full-featured Invoice Management Web Application built with React, TypeScript, Vite and Tailwind CSS. This project allows users to create, edit, delete and manage invoices with a clean, responsive and beautiful interface.",
  ...
  es: {
    ...
    projectTitle4: "Aplicación de Facturación",
    projectDescription4: "Una aplicación web completa para la gestión de facturas, desarrollada con React, TypeScript, Vite y Tailwind CSS. Este proyecto permite a los usuarios crear, editar, eliminar y gestionar facturas con una interfaz limpia, responsiva y atractiva.",
    projectTitle5: "MyFitnessApp",
